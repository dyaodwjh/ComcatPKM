...
<body>
	...
	<div align="right">
		<table id="contentTable" class="table table-striped table-bordered table-condensed">
			<thead><tr><th>名称</th><th>类别</th><th>需要root</th><th>支持Android版本</th><th>状态</th><th>管理</th></tr></thead>
			<tbody>
	...
	<div class="form-actions">
		<div><a class="btn btn-primary" href="${ctx}/api/agent/create">添加API</a>总数：${sum}</div>
	</div>	
	</div>
