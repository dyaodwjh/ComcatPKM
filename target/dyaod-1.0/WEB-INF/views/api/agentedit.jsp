	   ...
	   <c:if test="${action == 'update'}">
		...
		<fieldset>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text"  id="type" name="type" class="input-large" value="${form.type}"/>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <textarea id="exception" name="exception" class="input-large" cols="30" rows="5">${form.exception}</textarea>
                </div>
            </div>
